...
slug: using-claude-3-5-sonnet-to-refactor-one-of-brian-okken-s-python
title: 🚜 Using Claude 3.5 Sonnet to refactor one of Brian Okken's Python projects
redirect_to: https://micro.webology.dev/2024/08/25/using-claude-sonnet-to-refactor/
tags:
- Django
- Python
- UV
...
These efforts are powered by [Hugo van Kemenade](https://github.com/hugovk/)’s excellent [Top PyPI Packages](https://hugovk.github.io/top-pypi-packages/).
