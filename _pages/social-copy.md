---
layout: default
permalink: /social/copy/
sitemap: false
title: Social Media Banner
---

<h2 class="text-4xl">Contact / Social Media</h2>
...
<button class="btn border-2 border-black p-2 rounded-xl" data-clipboard-action="copy" data-clipboard-target="#simple">
    Copy to clipboard
</button>

----

<h2 class="text-4xl">All Social Icons</h2>

<div class="flex flex-wrap ">
{% for social in site.data.social %}
<a class="size-20" href="{{ social.url }}"><img src="{{ social.icon }}"></a>
{% endfor %}
</div>
...
<button class="btn border-2 border-black p-2 rounded-xl" data-clipboard-action="copy" data-clipboard-target="#all">
    Copy to clipboard
</button>
